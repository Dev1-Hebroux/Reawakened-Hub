      ...
      <main className="pt-28 pb-32 px-4">
        <div className="max-w-lg mx-auto">
          ...
          >
            ...
            {streak > 0 && (
              <div className="mt-4 inline-flex items-center gap-2 bg-orange-500/20 rounded-full px-4 py-2 border border-orange-500/40">
          ...
          >
            <div className="bg-[#19233b] rounded-2xl p-4 text-center border-t-2 border-primary">
              <div className="text-2xl font-bold text-white">{prayerStats?.totalHours || 0}</div>
              <div className="text-xs text-white/60">Prayer Hours</div>
            </div>
            <div className="bg-[#19233b] rounded-2xl p-4 text-center border-t-2 border-primary">
              <div className="text-2xl font-bold text-white">{prayerStats?.totalIntercessors || 0}</div>
              <div className="text-xs text-white/60">Intercessors</div>
            </div>
            <div className="bg-[#19233b] rounded-2xl p-4 text-center border-t-2 border-primary">
              <div className="text-2xl font-bold text-white">{prayerStats?.campusesCovered || 0}</div>
              <div className="text-xs text-white/60">Campuses</div>
            </div>
          </motion.div>

          {/* Adopt a Focus Section - Clean */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            {focusesLoading ? (
              ...
              <div className="space-y-2">
                {displayFocuses.map((group) => (
                  <div
                    key={group.id}
                    className="bg-white/5 hover:bg-white/10 rounded-xl p-4 cursor-pointer transition-colors border border-white/5"
